...
Faye.Client = Faye.Class({
  ...
  handshake: function(callback, context) {
    console.log("ITS TRYING TO MAKE HANDSHAKE");
    ...
    console.log("ITS ABOUT TO SEND!");
    console.log("FAYE HANDSHAKE: " + Faye.Channel.HANDSHAKE);
    console.log("FAYE BAYEUX_VERSION: " + Faye.BAYEUX_VERSION);
    console.log("SUPPORTED CONNECTION TYPES: " + this._transport.connectionType);
    window.fooTransport = this._transport;
    console.log("THIS IS TRANSPORT: " + this._transport);
    this._send({
      ...
      console.log('IT RESPONDED TO HANDSHAKE!');
      window.fayeResponse = response;
      ...
      if (response.successful) {        
        ...
        console.log("HANDSHAKE WAS UNSUCCESFUL!");
  ...
  _selectTransport: function(transportTypes) {
    this.debug("transport types: " + transportTypes);
  ...
  _deliverMessage: function(message) {
    ...
    console.log(message);
    console.log("Message supportedConnectionTypes: " + message.supportedConnectionTypes);
...
Faye.Transport = Faye.extend(Faye.Class({
  ...
  get: function(client, allowed, disabled, callback, context) {    
    ...
    console.log("get: disabled: " + disabled);    
    ...
    Faye.asyncEach(this._transports, function(pair, resume) {
      ...
      klass.isUsable(client, connEndpoint, function(isUsable) {
        console.log("connEndpoint: " + connEndpoint);
        console.log(pair[0] + " isUsable: " + isUsable);
...
Faye.Transport.EventSource = Faye.extend(Faye.Class(Faye.Transport, {
  initialize: function(client, endpoint) {
    ...
    console.log("**** CONNECT: " + endpoint + '/' + client.getClientId());
  ...
  isUsable: function(callback, context) {    
    this.callback(function() { 
      console.log("EVENTSOURCE ISUSABLE CALLBACK");
      callback.call(context, true) 
    });
    this.errback(function() { 
      console.log("EVENTSOURCE ISUSABLE ERROR");
  ...
  isUsable: function(client, endpoint, callback, context) {
    console.log("EventSource isUsable");
    var id = client.getClientId();
    console.log("ID: " + id);

    if (!id) return callback.call(context, false);

    console.log("Check XHR EventSource isUsable");
...
Faye.Transport.XHR = Faye.extend(Faye.Class(Faye.Transport, {
  ...
  isUsable: function(client, endpoint, callback, context) {
    console.log("XHR isUsable: " + Faye.URI.parse(endpoint).isSameOrigin());
...
Faye.Transport.JSONP = Faye.extend(Faye.Class(Faye.Transport, {
  ...
  request: function(messages, timeout) {
    console.log("IT CAME TO TRANSPORT JSONP REQUEST FUNC!!!!!");
    console.log("THIS IS MESSAGES FROM JSONP!!!!!");
    ...
    console.log("THIS IS CALLBACK NAME FORM JSONP: " + callbackName);
    Faye.ENV[callbackName] = function(data) {
      console.log('WE ARE IN JSONP CALLBACK!');
      console.log('THIS IS DATA FROM JSONP CALLBACK!!!!');
      console.log(data);
      cleanUp();
      self.receive(data);
      self.trigger('up');
    ...
    var timer = Faye.ENV.setTimeout(function() {
      console.log("WE ARE IN JSONP TIMEOUT!!!!");
      cleanUp();
      retry();
      self.trigger('down');
    }, 1.5 * 1000 * timeout);
    ...
    var cleanUp = function() {
      console.log('WE ARE IN JSONP CLEANUP!!!!');
    ...
    console.log("THIS IS SCRIPT FROM JSONP STUFF");
    console.log(script);
  }
}), {
  _cbCount: 0,
