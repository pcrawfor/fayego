...
func (f *FayeServer) addClientToSubscription(clientId, subscription string, c chan string) bool {
...
*/
func (f *FayeServer) addClientToServer(clientId, subscription string, c chan string) *Client {
